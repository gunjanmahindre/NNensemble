...
# MAIN FUNCTION
def main_code(fraction, w, path, data_path):
# if __name__ == "__main__":
    ...
    with tf.compat.v1.Session() as sess:
        ...
        np.savetxt(path + 'R_' + str(fraction) + '_option_' + ss + '.txt', R)
        # if fraction == 40 or fraction == 99:
            # R.to_csv('/content/drive/MyDrive/PhD work/Projects/ensemble/virgili results/fine tuning/' + ss + '/R_' + str(fraction) + '_option1' + '.csv', index = False)
